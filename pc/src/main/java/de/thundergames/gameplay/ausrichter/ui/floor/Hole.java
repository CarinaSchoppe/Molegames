 ...
 * File created on 20.01.22, 17:11 by Carina Latest changes made by Carina on 20.01.22, 17:11 All contents of "Hole" are protected by copyright. The copyright law, unless expressly indicated otherwise, is
...
/**
 * @author Carina
 * @use mechanic for the HolesConfiguration
 * @see CreateGame
 * @see HolesConfiguration
 */
@Data
@AllArgsConstructor
public class Hole {
