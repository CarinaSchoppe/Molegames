...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\textbf{Fromme, Philipp} & \textbf{24,75}\\ %Gesamtstunden
	\hline
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\textbf{Juozapaviciute, Eva} & \textbf{15,25}\\ %Gesamtstunden
	\hline
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\textbf{Lührmann, Nick} & \textbf{15,75}\\ %Gesamtstunden
	\hline
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\textbf{Rademann, Jana} & \textbf{13,5}\\ %Gesamtstunden
	\hline
