...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  1,5
	...
	%Taetigkeit
  Projektmanagement: öffentliches Treffen für Spielfeld
	&
	%Stundenzahl
  2,5
	\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\textbf{Fromme, Philipp} & \textbf{18}\\ %Gesamtstunden
	\hline
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\textbf{Lührmann, Nick} & \textbf{10}\\ %Gesamtstunden
	\hline
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\textbf{Rademann, Jana} & \textbf{8}\\ %Gesamtstunden
	\hline
