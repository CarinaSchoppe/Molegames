 ...
 * File created on 09.01.22, 12:04 by Carina Latest changes made by Carina on 09.01.22, 12:04 All contents of "MultiGameHandler" are protected by copyright. The copyright law, unless expressly indicated otherwise, is
...
public class MultiGameHandler {
  ...
  public void createNewGame(final int gameID) {
    if (!IDGames.containsKey(gameID)) {
      ...
      if (MoleGames.getMoleGames().getServer().isDebug()) System.out.println("Game already exists");
    }
  }
