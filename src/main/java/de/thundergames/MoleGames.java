 ...
 * File created on 21.12.21, 15:22 by Carina Latest changes made by Carina on 21.12.21, 15:21 All contents of "MoleGames" are protected by copyright. The copyright law, unless expressly indicated otherwise, is
  ...
  public static void main(@Nullable final String... args) {
    ...
    if (args.length == 0) {
      ...
      switch (Objects.requireNonNull(args[0])) {
        ...
        case "a":
          assert args[3] != null;
          MoleGames.getMoleGames().ai = new AI(Objects.requireNonNull(args[1]), Integer.parseInt(Objects.requireNonNull(args[2])), Integer.parseInt(Objects.requireNonNull(args[3])));
