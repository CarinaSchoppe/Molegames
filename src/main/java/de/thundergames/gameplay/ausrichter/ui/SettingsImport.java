...
public class SettingsImport {
  ...
  void onLoad(ActionEvent event) throws Exception {
    ...
    CreateGame.setPullDiscsOrderedPrev(new Gson().fromJson(object.get("pullDiscsOrdered").getAsString(), Boolean.class));
    CreateGame.setThinkTimePrev(new Gson().fromJson(object.get("turnTime").getAsString(), String.class));
    CreateGame.setVisualEffectsPrev(new Gson().fromJson(object.get("visualisationTime").getAsString(), String.class));
    CreateGame.setPunishmentPrev(new Gson().fromJson(object.get("movePenalty").getAsString(), String.class));
  ...
  void onSave(ActionEvent event) throws IOException {
    ...
    json.addProperty("maxPlayers", CreateGame.getMaxPlayersPrev() != null ? Integer.parseInt(CreateGame.getMaxPlayersPrev()) : 5);
    json.addProperty("radius", CreateGame.getRadiusPrev() != null ? Integer.parseInt(CreateGame.getRadiusPrev()) : 8);
    json.addProperty("numberOfMoles", CreateGame.getMolesAmountPrev() != null ? Integer.parseInt(CreateGame.getMolesAmountPrev()) : 4);
  ...
  @FXML
  void initialize() {
    assert back != null : "fx:id=\"back\" was not injected: check your FXML file 'ConfigLoader.fxml'.";
    assert displayText != null : "fx:id=\"displayText\" was not injected: check your FXML file 'ConfigLoader.fxml'.";
    assert load != null : "fx:id=\"load\" was not injected: check your FXML file 'ConfigLoader.fxml'.";
    assert pane != null : "fx:id=\"pane\" was not injected: check your FXML file 'ConfigLoader.fxml'.";
    assert save != null : "fx:id=\"save\" was not injected: check your FXML file 'ConfigLoader.fxml'.";
    assert window != null : "fx:id=\"window\" was not injected: check your FXML file 'ConfigLoader.fxml'.";
  }
}
