 ...
 * File created on 23.12.21, 17:40 by Carina Latest changes made by Carina on 23.12.21, 17:40 All contents of "MainGUI" are protected by copyright. The copyright law, unless expressly indicated otherwise, is
...
public class MainGUI extends Application implements Initializable {
  ...
  void onBreak(ActionEvent event) {
    ...
    if (selectedItem == null) {
      ...
      if (MoleGames.getMoleGames().getGameHandler().getIDGames().get(selectedItem.getGameID()).getCurrentGameState() == GameStates.STARTED) {
        MoleGames.getMoleGames().getGameHandler().getIDGames().get(selectedItem.getGameID()).pauseGame();
        JOptionPane.showMessageDialog(null, "Spiel wurde erfolgreich pausiert!", "Erfolg!", JOptionPane.ERROR_MESSAGE);
      } else {
        JOptionPane.showMessageDialog(null, "Das Spiel ist nicht im Started GameState!", "Spiel Gamestate!", JOptionPane.ERROR_MESSAGE);
      }
    }
  }
  ...
  void onContinue(ActionEvent event) {
    ...
    if (selectedItem == null) {
      ...
      if (MoleGames.getMoleGames().getGameHandler().getIDGames().get(selectedItem.getGameID()).getCurrentGameState() == GameStates.PAUSED) {
        MoleGames.getMoleGames().getGameHandler().getIDGames().get(selectedItem.getGameID()).resumeGame();
        JOptionPane.showMessageDialog(null, "Spiel wurde erfolgreich weitergeführt!", "Erfolg!", JOptionPane.ERROR_MESSAGE);
      } else {
        JOptionPane.showMessageDialog(null, "Das Spiel ist nicht im Paused GameState!", "Spiel Gamestate!", JOptionPane.ERROR_MESSAGE);
      }
    }
  }
  ...
  void onEnd(ActionEvent event) {
    ...
    if (selectedItem == null) {
      ...
      if (MoleGames.getMoleGames().getGameHandler().getIDGames().get(selectedItem.getGameID()).getCurrentGameState() != GameStates.OVER && MoleGames.getMoleGames().getGameHandler().getIDGames().get(selectedItem.getGameID()).getCurrentGameState() != GameStates.NOT_STARTED) {
        MoleGames.getMoleGames().getGameHandler().getIDGames().get(selectedItem.getGameID()).forceGameEnd();
        JOptionPane.showMessageDialog(null, "Spiel wurde erfolgreich beendet!", "Erfolg!", JOptionPane.ERROR_MESSAGE);
      } else {
        JOptionPane.showMessageDialog(null, "Das Spiel ist nicht irgendwie am laufen!", "Spiel Gamestate!", JOptionPane.ERROR_MESSAGE);
      }
    }
  }
  ...
  @FXML
  void initialize() {
    assert breakButton != null : "fx:id=\"breakButton\" was not injected: check your FXML file 'Main.fxml'.";
    assert continueButton != null : "fx:id=\"continueButton\" was not injected: check your FXML file 'Main.fxml'.";
    assert createGame != null : "fx:id=\"createGame\" was not injected: check your FXML file 'Main.fxml'.";
    assert createTournament != null : "fx:id=\"createTournament\" was not injected: check your FXML file 'Main.fxml'.";
    assert editGame != null : "fx:id=\"editGame\" was not injected: check your FXML file 'Main.fxml'.";
    ...
    assert gamePlayerCount != null : "fx:id=\"gamePlayerCount\" was not injected: check your FXML file 'Main.fxml'.";
    assert gameState != null : "fx:id=\"gameState\" was not injected: check your FXML file 'Main.fxml'.";
    assert gameTable != null : "fx:id=\"gameTable\" was not injected: check your FXML file 'Main.fxml'.";
    assert startGame != null : "fx:id=\"startGame\" was not injected: check your FXML file 'Main.fxml'.";
    assert tournamentID != null : "fx:id=\"tournamentID\" was not injected: check your FXML file 'Main.fxml'.";
    assert tournamentPlayerCount != null : "fx:id=\"tournamentPlayerCount\" was not injected: check your FXML file 'Main.fxml'.";
    assert tournamentState != null : "fx:id=\"tournamentState\" was not injected: check your FXML file 'Main.fxml'.";
    assert tournamentTable != null : "fx:id=\"tournamentTable\" was not injected: check your FXML file 'Main.fxml'.";
    ...
    tournamentPlayerCount.setCellValueFactory(new PropertyValueFactory<>("CurrentPlayerCount_MaxCount"));
