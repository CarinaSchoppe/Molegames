 ...
 * File created on 23.12.21, 11:37 by Carina Latest changes made by Carina on 23.12.21, 11:37 All contents of "ClientPacketHandler" are protected by copyright. The copyright law, unless expressly indicated otherwise, is
...
public class ClientPacketHandler {
  ...
  protected void handleTournamentGamesOverviewPacket() {
    client
      .getTournaments()
      .addAll(new Gson().fromJson(packet.getValues().get("games").getAsString(), new TypeToken<ArrayList<Game>>() {
      }.getType()));
    updateTableView();
  }
