...
public class GameSelection implements Initializable {
  ...
  /**
   * Observe the game.
   * If game is already started, spectate the game,
  ...
  void spectateGame(ActionEvent event) throws IOException {
    ...
    if (selectedItem == null) {
      JOptionPane.showMessageDialog(null, "Es wurde kein Spiel selektiert!", "Spiel beobachten", JOptionPane.ERROR_MESSAGE);
      return;
    }
