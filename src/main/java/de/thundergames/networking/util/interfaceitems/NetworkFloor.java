 ...
 * File created on 15.12.21, 13:46 by Carina Latest changes made by Carina on 15.12.21, 13:04 All contents of "NetworkFloor" are protected by copyright. The copyright law, unless expressly indicated otherwise, is
...
public class NetworkFloor {
  ...
  public NetworkFloor(HashSet<NetworkField> holes, HashSet<NetworkField> drawAgainFields, int points) {
    this.holes = holes;
