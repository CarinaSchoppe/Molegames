 ...
 * File created on 20.12.21, 16:43 by Carina Latest changes made by Carina on 20.12.21, 16:18 All contents of "NetworkThread" are protected by copyright. The copyright law, unless expressly indicated otherwise, is
...
public abstract class NetworkThread extends Thread {
  ...
  private void readStringPacketInput(
    ...
    if (reciever instanceof ClientThread && !(reciever instanceof AIClientThread)) {
      ((ClientThread) reciever).getClient().getClientPacketHandler().handlePacket(packet);
      ...
      MoleGames.getMoleGames()
          .getServer()
          .getPacketHandler()
          .handlePacket(packet, (ServerThread) reciever);
    }
  }
